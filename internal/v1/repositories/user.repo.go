...
func (r *UserRepo) Create(c common.Context, input models.UserInput) (uint, error) {
	ctx := c.Context()
...
func (r *UserRepo) Read(c fiber.Ctx) (paginate.Page, []models.UserPage) {
...
func (r *UserRepo) Update(c common.Context, id any, input models.UserInput) error {
	ctx := c.Context()
	user, err := common.Cast[entities.User](input)
	if err != nil {
