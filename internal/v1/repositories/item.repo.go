...
type IItemRepo interface {
	common.IBaseCrudRepo[entities.Item, models.ItemInput, models.ItemPage]
}
...
func (r *ItemRepo) Create(c common.Context, input models.ItemInput) (uint, error) {
	ctx := c.Context()
...
func (r *ItemRepo) Read(c fiber.Ctx) (paginate.Page, []models.ItemPage) {
	items := make([]models.ItemPage, 0)
...
func (r *ItemRepo) Update(c common.Context, id any, input models.ItemInput) error {
	ctx := c.Context()
	item, err := common.Cast[entities.Item](input)
	if err != nil {
