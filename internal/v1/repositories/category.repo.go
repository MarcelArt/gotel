...
type ICategoryRepo interface {
	common.IBaseCrudRepo[entities.Category, models.CategoryInput, models.CategoryPage]
}
...
func (r *CategoryRepo) Create(c common.Context, input models.CategoryInput) (uint, error) {
	ctx := c.Context()
...
func (r *CategoryRepo) Read(c fiber.Ctx) (paginate.Page, []models.CategoryPage) {
	categories := make([]models.CategoryPage, 0)
...
func (r *CategoryRepo) Update(c common.Context, id any, input models.CategoryInput) error {
	ctx := c.Context()
	category, err := common.Cast[entities.Category](input)
	if err != nil {
