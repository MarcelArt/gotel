...
type ILocationRepo interface {
	common.IBaseCrudRepo[entities.Location, models.LocationInput, models.LocationPage]
}
...
func (r *LocationRepo) Create(c common.Context, input models.LocationInput) (uint, error) {
	ctx := c.Context()
...
func (r *LocationRepo) Read(c fiber.Ctx) (paginate.Page, []models.LocationPage) {
	locations := make([]models.LocationPage, 0)
...
func (r *LocationRepo) Update(c common.Context, id any, input models.LocationInput) error {
	ctx := c.Context()
	location, err := common.Cast[entities.Location](input)
	if err != nil {
