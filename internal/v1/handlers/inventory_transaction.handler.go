...
type InventoryTransactionHandler struct {
	service services.IInventoryTransactionService
}

var _ = entities.InventoryTransaction{}

func NewInventoryTransactionHandler(service services.IInventoryTransactionService) *InventoryTransactionHandler {
...
// @Accept       json
// @Produce      json
// @Param        transaction  body      models.InventoryTransactionInput  true  "Inventory transaction details"
...
func (h *InventoryTransactionHandler) Create(c fiber.Ctx) error {
	var tx models.InventoryTransactionInput
...
// @Success      200      {object}  paginate.Page{items=[]models.InventoryTransactionPage}
...
// @Param        transaction  body      models.InventoryTransactionInput  true  "Updated transaction details"
...
// @Success      200      {object}  common.JSONResponse{items=[]models.ItemCount}
// @Failure      400      {object}  common.JSONResponse
// @Failure      401      {object}  common.JSONResponse
// @Failure      500      {object}  common.JSONResponse
// @Security     ApiKeyAuth
