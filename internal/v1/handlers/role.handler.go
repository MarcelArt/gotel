...
// @Accept       json
// @Produce      json
// @Param        role  body      models.RoleInput  true  "Role details"
...
// @Success      200      {object}  paginate.Page{items=[]models.RolePage}
...
// @Param        role  body      models.RoleInput  true  "Updated role details"
