...
// @Accept       json
// @Produce      json
// @Param        category  body      models.CategoryInput  true  "Category details"
...
func (h *CategoryHandler) Create(c fiber.Ctx) error {
	var category models.CategoryInput
...
// @Success      200      {object}  paginate.Page{items=[]models.CategoryPage}
...
// @Param        category  body      models.CategoryInput  true  "Updated category details"
