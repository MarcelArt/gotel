...
func NewLocationHandler(service ILocationService) *LocationHandler {
...
// @Accept       json
// @Produce      json
// @Param        location  body      LocationInput  true  "Location details"
...
// @Success      200    {object}  paginate.Page{items=[]LocationPage}
...
// @Param        location  body      LocationInput  true  "Updated location details"
